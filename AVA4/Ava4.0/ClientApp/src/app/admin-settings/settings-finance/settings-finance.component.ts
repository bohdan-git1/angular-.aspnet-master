...
export class SettingsFinanceComponent implements OnInit {
	...
	settingsHoverAction: any[] = [{hover: false, selected: false, route: 'casepresentation'}, {hover: false, selected: false, route: 'insurance'}, {hover: false, selected: false, route: 'postingcodes'}, {hover: false, selected: false, route: 'payments'}, {hover: false, selected: false, route: 'vendors'}];
