...
export class SettingsOperationComponent implements OnInit {
	...
	settingsHoverAction: any[] = [{hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'ava-outreach'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'account'}, {hover: false, selected: false, route: 'templates'}, {hover: false, selected: false, route: 'referrals'}, {hover: false, selected: false, route: 'schedule'}, {hover: false, selected: false, route: 'users'}];
