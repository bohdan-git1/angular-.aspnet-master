...
@Component({
  selector: 'app-pmt-operations',
  templateUrl: './pmt-operations.component.html',
  styleUrls: ['./pmt-operations.component.css']
})
export class PmtOperationsComponent implements OnInit {
  ...
  windowHt: any;
	...
	settingsHoverAction: any[] = [{hover: false, selected: false, route: 'hr'}, {hover: false, selected: false, route: 'photogallery'}, {hover: false, selected: false, route: 'procedures'}, {hover: false, selected: false, route: 'treatmentplan'}];
